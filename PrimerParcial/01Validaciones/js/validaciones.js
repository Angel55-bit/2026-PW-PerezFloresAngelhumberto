...
Una expresion regualr es un patron donde se identifica que elementos seran validos vs cuales no, son reglas mediante las cuales realizamos la validacion de los datos ingresados por el usuario, en este caso, en un formulario.
*/
...
if (typeof document !== 'undefined') {
    ...
    formulario.addEventListener('submit', (evento) => {
        ...
        const mmensajeExito = document.getElementById('mensaje-exito');
        mmensajeExito.textContent = formularioValido ? 'Registro existoso!' : '';
    });
}